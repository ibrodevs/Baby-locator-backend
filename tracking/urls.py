...
from .views import (
    ...
    AroundAudioLiveStreamView,
    AroundAudioLiveUploadView,
...
urlpatterns = [
    ...
    path("around-audio/live/upload/", AroundAudioLiveUploadView.as_view()),
    ...
    path("children/<int:child_id>/around-audio/live/stream/", AroundAudioLiveStreamView.as_view()),
